...
Get-Item "C:\Users\nbt2573\Documents\SW_Backup\$year\" -ErrorAction SilentlyContinue
if (!$?)
    {
    New-Item "C:\Users\nbt2573\Documents\SW_Backup\$year\" -ItemType Directory
    }
 
# create a folder for every month
Get-Item "C:\Users\nbt2573\Documents\SW_Backup\$year\$month\" -ErrorAction SilentlyContinue
if (!$?)
    {
    New-Item "C:\Users\nbt2573\Documents\SW_Backup\$year\$month\" -ItemType Directory
    }
 
# create a folder for every day
Get-Item "C:\Users\nbt2573\Documents\SW_Backup\$year\$month\$today\" -ErrorAction SilentlyContinue
if (!$?)
    {
    New-Item "C:\Users\nbt2573\Documents\SW_Backup\$year\$month\$today\" -ItemType Directory
    }
 
# simple credential handling
$username = "cisco"
$username1 = ""
# $pwfile = "C:\Users\nbt2573\Documents\SW_Backup\password.txt"
$password = ConvertTo-SecureString -String "IT@admin2k17" -AsPlainText -Force
$Credentials = New-Object System.Management.Automation.PSCredential ($username, $password)
# put all the devices in this array
$switches_array = @()
$switches_array = Get-Content -Path "C:\Users\nbt2573\Documents\SW_Backup\switches.txt"
 
foreach ($switch in $switches_array)
    {
    # create a folder for every device
    Get-Item "C:\Users\nbt2573\Documents\SW_Backup\\$year\$month\$today\$switch" -ErrorAction SilentlyContinue
    if (!$?)
        {
        New-Item "C:\Users\nbt2573\Documents\SW_Backup\\$year\$month\$today\$switch" -ItemType Directory
        }
